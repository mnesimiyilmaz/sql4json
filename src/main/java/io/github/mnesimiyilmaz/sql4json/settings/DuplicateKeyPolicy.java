...
/**
 * Policy for handling duplicate keys in a JSON object during parsing by
 * {@link DefaultJsonCodecSettings}.
 *
 * <p>RFC 8259 permits multiple strategies; the choice matters for security because two
 * systems that disagree on which duplicate wins can desynchronize — analogous to
 * HTTP Parameter Pollution attacks. Defaults to {@link #REJECT} for fail-safe behavior.
 *
 * <p>Usage example:
 * <pre>{@code
