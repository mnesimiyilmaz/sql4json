 ...
 *
 * <p>Use {@link #INSTANCE} — do not call {@code new SqlNull()} directly. The singleton property is a convention; the
 * Java record type system does not enforce private construction.
 */
