 ...
 *
 * <p>Offsets are absolute into the source text, 0-based, with {@code endOffset}
 * exclusive ({@code [startOffset, endOffset)}) — matching {@link String#substring(int, int)}
 * and IntelliJ's {@code LexerBase} contract.
 *
