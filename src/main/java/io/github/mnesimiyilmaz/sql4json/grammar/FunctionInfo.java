 ...
 *
 * <p>Intended for read-only consumption by tooling. The catalog that populates these records is
 * {@link SQL4JsonGrammar#functions()}. Records do not participate in execution — the library evaluates functions via
 * {@code FunctionRegistry}, which is independent of this catalog.
 *
...
public record FunctionInfo(
        String name, Category category, int minArity, int maxArity, String signature, String description) {}
