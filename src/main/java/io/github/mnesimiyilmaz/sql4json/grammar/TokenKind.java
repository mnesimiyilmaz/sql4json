 ...
 *
 * <p>The mapping from grammar token types to {@code TokenKind} is internal to
 * {@link SQL4JsonGrammar}; see the v1.2.0 design spec for per-token decisions.
 *
 * @since 1.2.0
 */
public enum TokenKind {
    ...
    /**
     * Comparison and arithmetic operators ({@code =}, {@code !=}, {@code <}, {@code >}, {@code <=}, {@code >=}, {@code *}).
     */
    OPERATOR,
