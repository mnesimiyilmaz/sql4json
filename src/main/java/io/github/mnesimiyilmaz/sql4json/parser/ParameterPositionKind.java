...
/**
 * Describes the syntactic position of a parameter placeholder. Used by the bind-time validator to check the bound
 * value's type against the position's expectations.
 *
 * @since 1.2.0
 */
