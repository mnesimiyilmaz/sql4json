...
/**
 * Small helpers for unpacking a {@link Type} into its raw class and type arguments.
 * Used by {@link JsonValueMapper} to handle {@code List<T>}, {@code Map<String,V>},
 * {@code Optional<T>}, {@code T[]}, etc.
 */
