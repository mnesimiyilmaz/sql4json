...
/**
 * Registry of comparison operators (e.g. {@code =}, {@code !=}, {@code >}).
 * Holds a map of operator symbols to their predicate implementations.
 * The default instance is frozen (immutable) after creation.
 */
public final class OperatorRegistry {
    ...
    public static OperatorRegistry createDefault() {
        ...
        r.register(new ComparisonOperatorDef("!=", OperatorType.BINARY,
                (a, b) -> !r.getPredicate("=").test(a, b)));

        r.register(new ComparisonOperatorDef(">", OperatorType.BINARY,
                (a, b) -> SqlValueComparator.compare(a, b) > 0));
