...
/**
 * Comparator for {@link SqlValue} instances with deterministic cross-type ordering.
 * Nulls sort first; within the same type, natural ordering applies.
 */
