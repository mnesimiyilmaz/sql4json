...
/**
 * Serializes a stream of rows into a JSON array string. Each row is unflattened, serialized, then discarded — O(1) per
 * row.
 */
public final class StreamingSerializer {
    ...
    /**
     * Serialize a stream of rows into a JSON array string. Each row is unflattened and serialized inline, then
     * discarded.
     *
    ...
    public static String serialize(
            Stream<RowAccessor> rows, List<SelectColumnDef> columns, FunctionRegistry functionRegistry, int maxRows) {
