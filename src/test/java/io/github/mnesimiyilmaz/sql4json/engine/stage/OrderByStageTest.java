...
class OrderByStageTest {
    ...
    void multi_column_uses_second_as_tiebreaker() {
        var row1 = Row.eager(Map.of(FieldKey.of("dept"), new SqlString("IT"),
                FieldKey.of("name"), new SqlString("Zara")));
        var row2 = Row.eager(Map.of(FieldKey.of("dept"), new SqlString("HR"),
    ...
    void top_n_multi_column_tiebreaker() {
        var r1 = Row.eager(Map.of(FieldKey.of("dept"), new SqlString("IT"),
                FieldKey.of("name"), new SqlString("Zara")));
        var r2 = Row.eager(Map.of(FieldKey.of("dept"), new SqlString("HR"),
                FieldKey.of("name"), new SqlString("Alice")));
    ...
    void top_n_stage_is_not_lazy() {
        assertFalse(new TopNOrderByStage(
                List.of(OrderByColumnDef.of("age", "ASC")), 0, 10, fn, NO_LIMIT).isLazy());
    }
