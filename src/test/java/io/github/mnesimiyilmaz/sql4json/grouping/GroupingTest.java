...
class GroupingTest {
    ...
    class GroupAggregatorTests {
        ...
        void count_stored_under_alias_key() {
            ...
            var row2 = Row.eager(
                    Map.of(FieldKey.of("dept"), new SqlString("IT"), FieldKey.of("name"), new SqlString("Bob")));
    ...
    class GroupKeyTests {
        ...
        void different_values_are_not_equal() {
            assertNotEquals(new GroupKey(List.of(new SqlString("IT"))), new GroupKey(List.of(new SqlString("HR"))));
        }
